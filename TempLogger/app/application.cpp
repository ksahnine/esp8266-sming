...
void onIpConfig(HttpRequest &request, HttpResponse &response)
{
	if (request.getRequestMethod() == RequestMethod::POST)
	{
		...
		AppSettings.apikey = request.getPostParameter("apikey");
		AppSettings.period = atoi(request.getPostParameter("period").c_str());
	...
	vars["period"] = AppSettings.period;
	vars["apikey"] = AppSettings.apikey;
...
void init()
{
	...
	WifiAccessPoint.config("Traceur de température", "", AUTH_OPEN);
